...
function getClass( elem ) {
    ...
    return (elem.className || (elem.getAttribute && elem.getAttribute('class'))).trim();
}
/**
 * [hasClass 是否存在class]
 * @param  {[type]}  elem  [dom节点]
...
function addClass( elem, value ) {
    if( hasClass( elem, value ) ) return true;
...
function removeClass( elem, value ) {
    if( !hasClass ( elem, value ) ) return false;
